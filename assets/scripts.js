...
if (!window["Heartlove"]) {
  window.Heartlove = {
    data: {
messages: [
  "Chúc cô 20/10 thật nhiều sức khỏe và niềm vui 💐",
  "Cảm ơn cô vì những bài học và sự tận tâm 💖",
  "Cô luôn là người phụ nữ đáng kính và tuyệt vời nhất 🌸",
  "Chúc cô mãi xinh đẹp, hạnh phúc và thành công 💞",
  "Em kính chúc cô luôn vui vẻ và yêu đời ❤️"
],
      images: [],
      heartColor: "#ff9090",
    },
